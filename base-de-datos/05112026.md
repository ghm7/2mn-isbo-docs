...
- Recorrido (<u>N°Recorrido</u>, Duración, Precio, Kilómetros, **IdTOrigen**, **IdTDestino**) IdTOrigen -> Terminal, IdTDestino -> Terminal
- Empleado (<u>N°Empleado</u>, Nombre, Dirección, Salario, Cargo)
- Viaje (<u>N°Viaje</u>, FechaHora { Partida, Arribo }, **N°Recorrido**) N°Recorrido -> Recorrido
- Omnibus (<u>Matrícula</u>, CantidadAsientos, Marca, Modelo, N°Serie)
- Pasajero (<u>Tipo</u>, <u>N°Documento</u>, Nombre, Dirección, Teléfono)
- Pasaje (<u>N°Pasaje</u>, N°Asiento, Tipo de Asiento, **N°Viaje**, **Tipo**, **N°Documento**) N°Viaje -> Viaje, (Tipo, N°Documento) -> Pasajero
- pasa (<u>IdT</u>, <u>N°Recorrido</u>) IdT -> Terminal, N°Recorrido -> Recorrido
- trabaja (<u>N°Empleado</u>, <u>N°Viaje</u>) N°Empleado -> Empleado, N°Viaje -> Viaje
