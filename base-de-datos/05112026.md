...
- Terminal (<u>IdT</u>, Nombre, País)
- Recorrido (<u>N°Recorrido</u>, Duración, Precio, Kilómetros, **IdTOrigen**,
  **IdTDestino**) IdTOrigen -> Terminal, IdTDestino -> Terminal
- Empleado (<u>N°Empleado</u>, Nombre, Dirección, Salario, Cargo)
- Viaje (<u>N°Viaje</u>, FechaHora { Partida, Arribo }, **N°Recorrido**)
  N°Recorrido -> Recorrido
- Omnibus (<u>Matrícula</u>, CantidadAsientos, Marca, Modelo, N°Serie)
- Pasajero (<u>Tipo</u>, <u>N°Documento</u>, Nombre, Dirección, Teléfono)
- Pasaje (<u>N°Pasaje</u>, N°Asiento, Tipo de Asiento, **N°Viaje**, **Tipo**,
  **N°Documento**) N°Viaje -> Viaje, (Tipo, N°Documento) -> Pasajero
- pasa (<u>IdT</u>, <u>N°Recorrido</u>) IdT -> Terminal, N°Recorrido ->
  Recorrido
- trabaja (<u>N°Empleado</u>, <u>N°Viaje</u>) N°Empleado -> Empleado, N°Viaje ->
  Viaje
- utiliza (<u>Matrícula</u>, N°Viaje) Matrícula -> Omnibus, N°Viaje -> Viaje

> [!NOTE]
>
> _origen_, _destino_, _realiza_, _tiene_ y _compra_ se simplifican agregando
> claves foráneas en la tabla que queda del lado N con totalidad. _pasa_ y
> _trabaja_ quedan como tablas porque son relaciones N a N.
