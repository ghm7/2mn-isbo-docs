...
Correo del profesor: leonardocarambula@gmail.com
...
- Un conjunto de datos relacionados entre si y almacenados por un prolongado
  periodo de tiempo.
...
- Clasificación:
  ...
  - Modelos físicos
    ...
    - Utilizadas dentro de los gestores (SGDB), con relativamente poco control
      desde afuera de los mismos
...
1. Agrupación, colección o clase de objetos del mismo tipo, denominados
