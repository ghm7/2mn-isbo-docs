...
- Tienen que estar el cero después de la coma pero no puede haber otro número que no sea el cero
...
- Son los naturales y los opuestos de los naturales excepto el cero porque no tiene signo
...
- Pueden expresarse como el cociente (fracción) de dos números enteros, donde el denominador es distinto de cero
