...
>
> Uncertain transcription: the sentence near the bottom seems to explain a shortcut to avoid using Bhaskara in some cases, but the handwriting is not clear enough to recover exactly.
...
> [TODO]: Type it manually
>
> Uncertain transcription: the handwritten sign scheme at the right margin is partially legible, but it appears to derive the sign of the quadratic from the signs of $(x-\alpha)$, $(x-\beta)$, and $a$.
